...
RSpec.describe(GovukComponentsHelper, type: 'helper') do
  ...
  [
    ...
    {
      helper_method: :govuk_feedback,
      klass: GovukComponent::FeedbackComponent,
      args: [],
      kwargs: { title_text: 'Some title', text: 'Some text' },
      css_matcher: %(.govuk-feedback)
    },
    {
    ...
    },
    {
      ...
      block: Proc.new { |nb| nb.with_heading(text: "heading 1", link_text: "link 1", link_href: "/link-1") },
    },
    {
